...
namespace ExtensibleCharacterController.Characters
{
    ...
    public class ECCCharacterMotor : ECCBehaviour
    {
        [SerializeField]
        private ECCFloatReference _accelerationRate = 10.0f;
        [SerializeField]
        private ECCVector2Reference m_TurnSensitivity = new Vector2(5.0f, 5.0f);
