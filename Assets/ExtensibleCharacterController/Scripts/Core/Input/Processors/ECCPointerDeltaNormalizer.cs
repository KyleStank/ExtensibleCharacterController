...
namespace ExtensibleCharacterController.Core.Input.Processors
{
    /// <summary>
    ...
    [InitializeOnLoad]
    #endif
    public class ECCPointerDeltaNormalizer : InputProcessor<Vector2>
    {
        #if UNITY_EDITOR
        static ECCPointerDeltaNormalizer()
        {
            Initialize();
        }
        #endif
        ...
        {
            InputSystem.RegisterProcessor<ECCPointerDeltaNormalizer>();
        }
