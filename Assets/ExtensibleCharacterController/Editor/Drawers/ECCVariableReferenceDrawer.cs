...
namespace ExtensibleCharacterController.Editor.Drawers
{
    [CustomPropertyDrawer(typeof(ECCBaseVariableReference), true)]
    public sealed class ECCVariableReferenceDrawer : PropertyDrawer
    {
